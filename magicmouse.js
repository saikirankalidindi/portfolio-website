...
(() => {
  var e = {
      763: (e, t, r) => {
        ...
        a.push([
          e.id,
          "body #magicMouseCursor{position:fixed;width:35px;height:35px;border:2px solid #f75023;border-radius:50%;z-index:9999;left:0;top:0;transition:transform .05s,width .3s,height .3s;pointer-events:none}body #magicMouseCursor.cursor-square{offsetWidth:30px;border-radius:25px}body #magicMouseCursor.cursor-circle {border-radius: 50%;background-color:blue}body #magicPointer{height:6px;width:6px;top:0;left:0;position:fixed;background:#f75023;border-radius:50%;pointer-events:none;transition:background .2s,width .2s,height .2s,box-shadow .2s}body #magicPointer.pointer-blur{height:50px;width:50px;background:none;border:1px solid #fff;box-shadow:0px 0px 15px -5px #fff}body #magicPointer.pointer-overlay{height:70px;width:70px;mix-blend-mode:difference;box-shadow:0px 0px 15px -5px;opacity:0.3;}body #magicPointer.is-hover{background:red}body .magic-hover{transition:all .3s}body .magic-hover:hover{cursor:none}",
          "",
          {
            version: 3,
